    ...
    <main>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
        ...
        <label className="block mb-5">
          ...
          {errors.name && (
            <span className="text-red-500 block">The Name Field is required</span>
          )}
          <input
            {...register("name", { required: true })}
            className="shadow border rounded py-2 px-3 form-inpur mt-1 block w-full ring-yellow-500 outline-none focus:ring"
            placeholder="Israel Ojeifo"
            type="text"
          />
        </label>
        <label className="block mb-5">
          ...
          {errors.email && (
            <span className="text-red-500 block">The Email Field is required</span>
          )}
          <input
            {...register("email", { required: true })}
            className="shadow border rounded py-2 px-3 form-inpur mt-1 block w-full ring-yellow-500 outline-none focus:ring"
            placeholder="mail@easy.com"
            type="email"
          />
        </label>
        <label className="block mb-5">
          ...
          {errors.comment && (
            <span className="text-red-500 block">The Comment Field is required</span>
          )}
          <textarea
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // update cache after 60 sec
  }
}
